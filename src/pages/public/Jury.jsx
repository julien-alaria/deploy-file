...
import ThreeCards from "../../components/home/cards/ThreeCards";
 ...
 <div className="w-full pt-8">
      ...
      <section className="flex flex-col lg:flex-row justify-center items-center mt-6 md:mt-8 mb-8 gap-6 px-4 md:px-8">
        <div className="flex justify-center">
          <img
            className="w-80 max-w-xs sm:max-w-sm md:max-w-md rounded-xl grayscale-30"
            src={photoPierre}
            alt="Président du jury"
          />
        </div>
...
<JuryCard 
image={tinaBaz} 
membertitle={t("pages.juryPublic.members.tina.name")} 
membersstitle={t("pages.juryPublic.members.tina.role")} />   
          
          <JuryCard 
          image={jeromeGenevray} 
          membertitle={t("pages.juryPublic.members.jerome.name")} 
          membersstitle={t("pages.juryPublic.members.jerome.role")} 
          />

          <JuryCard 
          image={eveMachuel} 
          membertitle={t("pages.juryPublic.members.eve.name")} 
          membersstitle={t("pages.juryPublic.members.eve.role")} />

          <JuryCard 
          image={anneNovel} 
          membertitle={t("pages.juryPublic.members.anne.name")} 
          membersstitle={t("pages.juryPublic.members.anne.role")} />

          <JuryCard 
          image={vipulan} 
          membertitle={t("pages.juryPublic.members.vipulan.name")} 
          membersstitle={t("pages.juryPublic.members.vipulan.role")} />

          <JuryCard 
          image={barbara} 
          membertitle={t("pages.juryPublic.members.barbara.name")} 
          membersstitle={t("pages.juryPublic.members.barbara.role")} />
      ...
      {/* CARDS DE CRITÈRES */}
      <section className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6 justify-items-center pt-10 md:pt-20 pb-10 md:pb-20 px-4">

        {/* AI Card */}
       <ThreeCards 
       icon={ <svg className=" bg-[#252525] rounded-full p-1 border-[#ad46ff]/50 border-2 hover:shadow-[0_0_20px_rgba(173,70,255,0.8)] transition-shadow duration-200" height="55" width="55" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"> <path d="M7 4.5a3 3 0 0 0-2.567 4.554a3.001 3.001 0 0 0 0 5.893M7 4.5a2.5 2.5 0 0 1 5 0v15a2.5 2.5 0 0 1-5 0a3 3 0 0 1-2.567-4.553M7 4.5c0 .818.393 1.544 1 2m-3.567 8.447A3 3 0 0 1 6 13.67m13.25-8.92L17 7h-2m3.5-2.25a.75.75 0 1 0 1.5 0a.75.75 0 0 0-1.5 0m.75 14.5L17 17h-2m3.5 2.25a.75.75 0 1 1 1.5 0a.75.75 0 0 1-1.5 0m.75-7.25H15m3.5 0a.75.75 0 1 0 1.5 0a.75.75 0 0 0-1.5 0" fill="none" stroke="#AD46FF" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5"/> </svg> }
          title={t("pages.juryPublic.criteria.ai.title")}
          description={t("pages.juryPublic.criteria.ai.description")}
          accentColor="#AD46FF"
          borderColor="border-[rgba(173,70,255,0.40)]"
          hoverShadow="hover:shadow-[0_0_20px_rgba(173,70,255,0.7)]"
       />


{/* Aesthetic Card */}
<ThreeCards
icon={ <svg className="bg-[#252525] rounded-full p-1 border-[#00D492]/50 border-2 hover:shadow-[0_0_20px_rgba(0,212,146,0.8)] transition-shadow duration-200" height="55" width="55" viewBox="0 0 24 24">
          ...
          title={t("pages.juryPublic.criteria.aesthetic.title")}
          description={t("pages.juryPublic.criteria.aesthetic.description")}
          accentColor="#00D492"
          borderColor="border-[rgba(0,212,146,0.40)]"
          hoverShadow="hover:shadow-[0_0_20px_rgba(0,212,146,0.7)]"
/>
{/* Story Card */}
<ThreeCards 
icon={<svg className="bg-[#252525] rounded-full p-1 border-[#F6339A]/50 border-2 hover:shadow-[0_0_20px_rgba(246,51,154,0.8)] transition-shadow duration-200" height="55" width="55" viewBox="0 0 512 512">
          ...
          title={t("pages.juryPublic.criteria.story.title")}
          description={t("pages.juryPublic.criteria.story.description")}
          accentColor="#F6339A"
          borderColor="border-[rgba(246,51,154,0.40)]"
          hoverShadow="hover:shadow-[0_0_20px_rgba(246,51,154,0.7)]"
/>

        
<ThreeCards 
icon={<svg className="bg-[#252525] rounded-full p-1.5 border-[#00B8DB]/50 border-2 hover:shadow-[0_0_20px_rgba(0,184,219,0.8)] transition-shadow duration-200" height="55" width="55" viewBox="0 0 24 24">
          ...
          title={t("pages.juryPublic.criteria.emotion.title")}
          description={t("pages.juryPublic.criteria.emotion.description")}
          accentColor="#00B8DB"
          borderColor="border-[rgba(0,184,219,0.40)]"
          hoverShadow="hover:shadow-[0_0_20px_rgba(0,184,219,0.7)]"
/>
